import outscore from './outscore/outscore.routes.js';
import fixtures from './fixtures/fixtures.routes.js';
...
import leagues from './leagues/leagues.routes.js';

export { outscore, fixtures, teams, betshelper, injuries, players, standings, leagues };
